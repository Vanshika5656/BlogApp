...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    user: 'vanshika1516.be21@chitkara.edu.in',
    pass: 'qapq iwum ccse uqpb',
  },
});
const sendVerificationEmail =(email, verificationToken) => {
  ...
  const mailOptions = {
    from: 'vanshika1516.be21@chitkara.edu.in',
    to: email,
...
const authController = {
 ...
 register : async (req, res) => {
  try {
    ...
    const isAdmin = username.toLowerCase() === 'vanshika' && email.toLowerCase() === 'vanshika1516.be21@chitkara.edu.in';
